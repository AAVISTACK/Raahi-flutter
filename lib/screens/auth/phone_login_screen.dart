// ============================================================
// lib/screens/auth/phone_login_screen.dart  (UPDATED)
// Changes:
//   - Top pe language selector chips (6 languages)
//   - Default: English
//   - Saare texts LanguageService se — language change hone
//     par poori screen turant update hoti hai
//   - Google Sign-In button bhi hai
// ============================================================
              ...
              children: [
                ...
                Center(
                  child: TextButton(
                    ...
                    child: Text(
                      _lang.t('mechanic_register_link'),
                      style: const TextStyle(
...
class _GooglePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
      Offset(cx, cy), Offset(cx + r * 0.72, cy),
      Paint()
