    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Galat OTP hai. Dobara try karo.')),
        );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '${widget.phone} pe 6-digit OTP bheja gaya hai',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _loading
                      ...
                      : const Text('Verify Karo ✓', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700)),
                ),
              ),
              ...
              Center(
                child: _resendSeconds > 0
                    ...
                    : TextButton(
                        onPressed: () {
                          ApiService().sendOtp(widget.phone);
                          setState(() => _resendSeconds = 30);
                          _startResendTimer();
                        },
                        child: const Text('OTP Dobara Bhejo', style: TextStyle(color: AppTheme.saffron)),
                      ),
              ),
            ],
          ),
